...
class SearchResultView @JvmOverloads constructor(context: Context, attributeSet: AttributeSet) :
    ...
    MVIView<SearchCharacterViewIntent, SearchCharacterViewState> {
    ...
    private val saveSearchIntent: Flow<SearchCharacterViewIntent>
        get() = searchResultAdapter.clicks
            .onEach(navigator.get()::openCharacterDetail)
            .map(SearchCharacterViewIntent::SaveSearch)
