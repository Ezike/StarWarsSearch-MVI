...
private fun SearchHistory() {
    Row {
        Text(
            ...
            text = stringResource(id = R.string.recent_searches).toUpperCase(
        ...
        Text(
            modifier = Modifier.clickable(onClick = { /*TODO*/ }).padding(16.dp),
            text = stringResource(id = R.string.clear_search_history).toUpperCase(
                ConfigurationCompat.getLocales(
                    AmbientConfiguration.current
                )[0]
            )
