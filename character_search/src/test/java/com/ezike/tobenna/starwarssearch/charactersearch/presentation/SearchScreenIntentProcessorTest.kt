...
import com.ezike.tobenna.starwarssearch.charactersearch.fakes.FakeSearchHistoryRepository
...
class SearchScreenIntentProcessorTest {
    ...
    private val resultRecorder: FlowRecorder<SearchScreenResult> = FlowRecorder(
